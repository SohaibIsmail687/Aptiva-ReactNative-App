  ...
  render() {
    ...
    return (
      ...
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 15, backgroundColor: '#781517', paddingHorizontal: 15, borderBottomColor: 'gray', borderBottomWidth: 0.5 }}>
                    ...
                    <Text style={{ fontSize: 18, fontWeight: 'bold', color: 'white', }}>Your Cart</Text>
                    <Text style={{ fontSize: 22, fontWeight: 'bold', color: 'black', }}>    </Text>
                </View>


        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 20, alignSelf: 'center', marginTop: 10 }}>
          {this.state.skalton == true ?
            <View style={{ flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap', justifyContent: 'space-between', paddingHorizontal: 15 }}>
              <SkeletonPlaceholder >
                <View
                  style={{ height: 180, width: width / 2.5, paddingBottom: 10, backgroundColor: 'white', borderRadius: 8, shadowOffset: { width: 0, height: 2, }, shadowOpacity: 0.25, shadowRadius: 3.84, elevation: 3, marginLeft: 7, marginRight: 7, marginBottom: 5, marginTop: 15, alignItems: 'center', justifyContent: 'center', paddingVertical: 15 }}
                ></View>
              </SkeletonPlaceholder>
              <SkeletonPlaceholder>
                <View
...
<View style={{marginLeft:13,width:'65%'}}>
   <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between'}}>
       <Text style={{color:'black',fontWeight:'bold',fontSize:16}}>ALARUP 200 mg</Text>
...
<View style={{flexDirection:'row', width:'100%', alignItems:'center',justifyContent:'space-between',}}>
    <View>
   <Text style={{color:'gray',fontSize:13}}>USD 14 * 1</Text>
...
name="pluscircle"
type="AntDesign"
style={{ color: "#781517", fontSize: 20,  }}
/>

<Text style={{color:'gray',fontSize:13,fontWeight:'bold'}}>  1  </Text>
...
<Text style={{ color: 'black', fontWeight: 'bold', fontSize: 15,marginLeft:20 }}>Total: <Text style={{color: '#781517', fontWeight: 'bold', fontSize: 15}}>24$</Text></Text>
         ...
         style={{ width: width / 2, marginBottom:10, alignSelf: 'center', justifyContent: 'center', alignItems: 'center', paddingVertical: 13, borderRadius: 100, backgroundColor: '#781517', marginTop:20, shadowOffset: { width: 0, height: 2, }, shadowOpacity: 0.25, shadowRadius: 3.84, elevation: 3,   }}>
...
const styles = StyleSheet.create({
  ...
  active_button: {
    justifyContent: 'center', alignItems: 'center', paddingVertical: 8, width: width / 2.2, borderBottomWidth: 2, borderColor: '#5b9ed2'
  },
  in_active_button: {
  ...
  active_text: {
    color: '#5b9ed2', fontWeight: '500', fontSize: 14
  },
  in_active_text: {
