            ...
            <View style={{ flex: 1, backgroundColor: 'white' }}>
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <ScrollView>
                        ...
                        <Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18, paddingTop: 15 }}>Your use of Neurolife is subject to these Terms of Use.</Text>

                     
                        <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', marginHorizontal: 15, marginTop: 20 }}>1. AGREEMENT TO TERMS </Text>
                        <Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18,marginTop:4}}>These Terms of Use constitute a legally binding agreement made between you, whether
personally or on behalf of an entity (“you”) and Twin Cities Health Services
("Company," “we," “us," or “our”), concerning your access to and use of the
Neurolifetherapy.com website as well as any other media form, media channel, mobile website
or mobile application related, linked, or otherwise connected thereto
(collectively, the “Site”). We are registered in Minnesota, United States and have our registered
office at 3255 Hennepin Ave S, Minneapolis, MN 55408. You agree that by accessing the Site,
...
in our sole discretion, to make changes or modifications to these Terms of Use at any time and
...
not permitted to use or register for the Site.</Text>

                        <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', marginHorizontal: 15, marginTop: 20 }}>2. INTELLECTUAL PROPERTY RIGHTS </Text>
                        <Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18,marginTop:4}}>Unless otherwise indicated, the Site is our proprietary property and all source code, databases,
...
expressly granted to you in and to the Site, the Content and the Marks.
                        ...
                        <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', marginHorizontal: 15,marginTop: 20  }}>3. USER REPRESENTATIONS</Text>
                        <Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18, paddingTop: 4 }}>By using the Site, you represent and warrant that: (1) you have the legal capacity and you
...
the Site (or any portion thereof).
                        ...
                        <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', marginHorizontal: 15, marginTop: 20 }}>4. PROHIBITED ACTIVITIES </Text>
                        <Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18, paddingTop: 4 }}>You may not access or use the Site for any purpose other than that for which we make the Site available. The Site may not be used in connection with any commercial endeavors except those that are specifically endorsed or approved by us. As a user of the Site, you agree not to:{"\n"}
 

<Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18, paddingTop: 4 }}>⦁ Systematically retrieve data or other content from the Site to create or compile, directly or
indirectly, a collection, compilation, database, or directory without written permission from
us.{"\n"}
</Text>
<Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18, paddingTop: 4 }}>⦁ Trick, defraud, or mislead us and other users, especially in any attempt to learn sensitive
account information such as user passwords.{"\n"}
</Text>
<Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18, paddingTop: 4 }}>⦁ Circumvent, disable, or otherwise interfere with security-related features of the Site, including
...
<Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18, paddingTop: 4 }}>⦁ Disparage, tarnish, or otherwise harm, in our opinion, us and/or the Site.{"\n"}
</Text>
<Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18, paddingTop: 4 }}>⦁ Use any information obtained from the Site in order to harass, abuse, or harm another
person.{"\n"}</Text>
<Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18, paddingTop: 4 }}>⦁ Make improper use of our support services or submit false reports of abuse or misconduct.{"\n"}</Text>
<Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18, paddingTop: 4 }}>⦁ Use the Site in a manner inconsistent with any applicable laws or regulations. Engage in
unauthorized framing of or linking to the Site.{"\n"}</Text>
<Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18, paddingTop: 4 }}>⦁ Upload or transmit (or attempt to upload or to transmit) viruses, Trojan horses, or other
...
<Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18, paddingTop: 4 }}>⦁ Engage in any automated use of the system, such as using scripts to send comments or
messages, or using any data mining, robots, or similar data gathering and extraction tools.{"\n"}
</Text>
<Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18, paddingTop: 4 }}>⦁ Delete the copyright or other proprietary rights notice from any Content. Attempt to
impersonate another user or person or use the username of another user.{"\n"}
</Text>
<Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18, paddingTop: 4 }}>⦁ Upload or transmit (or attempt to upload or to transmit) any material that acts as a passive or
...
<Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18, paddingTop: 4 }}>⦁ Interfere with, disrupt, or create an undue burden on the Site or the networks or services
connected to the Site.{"\n"}
</Text>
<Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18, paddingTop: 4 }}>⦁ Harass, annoy, intimidate, or threaten any of our employees or agents engaged in providing
any portion of the Site to you.{"\n"}
</Text>
<Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18, paddingTop: 4 }}>⦁ Attempt to bypass any measures of the Site designed to prevent or restrict access to the
Site, or any portion of the Site.{"\n"}
</Text>
<Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18, paddingTop: 4 }}>⦁ Copy or adapt the Site’s software, including but not limited to Flash, PHP, HTML, JavaScript,
or other code.{"\n"}
</Text>
<Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18, paddingTop: 4 }}>⦁ Except as permitted by applicable law, decipher, decompile, disassemble, or reverse
engineer any of the software comprising or in any way making up a part of the Site.{"\n"}
</Text>
<Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18, paddingTop: 4 }}>⦁ Except as may be the result of standard search engine or Internet browser usage, use,
...
⦁ Sell or otherwise transfer your profile.{"\n"}</Text>
                        ...
                        <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', marginHorizontal: 15, marginTop: 20 }}>5. USER GENERATED CONTRIBUTIONS </Text>
                        <Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18,marginTop:4 }}>The Site does not offer users to submit or post content. We may provide you with the
...
material (collectively, "Contributions"). Contributions may be viewable by other users of the Site
and through third-party websites. As such, any Contributions you transmit may be treated in
...
otherwise violate, or link to material that violates, any provision of these Terms of Use, or any
applicable law or regulation.{"\n"}
Any use of the Site in violation of the foregoing violates these Terms of Use and may result in,
among other things, termination or suspension of your rights to use the Site.</Text>
 
                        <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', marginHorizontal: 15, marginTop: 20 }}>6. CONTRIBUTION LICENSE</Text>
                        <Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18,marginTop:4}}>You agree that we may access, store, process, and use any information and personal data that
...
responsibility and to refrain from any legal action against us regarding your Contributions.
                        ...
                        <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', marginHorizontal: 15, marginTop: 20 }}>7. MOBILE APPLICATION LICENSE </Text>
                        <Text style={{ color: 'black', fontSize: 14, fontWeight: 'bold', marginHorizontal: 15, marginTop: 10 }}>Use License</Text>

                        <Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18,marginTop:4}}>If you access the Site via a mobile application, then we grant you a revocable, non-exclusive, non-transferable, limited right to install and use the mobile application on wireless electronic devices owned or controlled by you, and to access and use the mobile application on such devices strictly in accordance with the terms and conditions of this mobile application license contained in these Terms of Use. You shall not: (1) except as permitted by applicable law, decompile, reverse engineer, disassemble, attempt to derive the source code of, or decrypt the application; (2) make any modification, adaptation, improvement, enhancement, translation, or derivative work from the application; (3) violate any applicable laws, rules, or regulations in connection with your access or use of the application; (4) remove, alter, or obscure any proprietary notice (including any notice of copyright or trademark) posted by us or the licensors of the application; (5) use the application for any revenue generating endeavor, commercial enterprise, or other purpose for which it is not designed or intended; (6) make the application available over a network or other environment permitting access or use by multiple devices or users at the same time;(7) use the application for creating a product, service, or software that is, directly or indirectly, competitive with or in any way a substitute for the application; (8) use the application to send automated queries to any website or to send any unsolicited commercial e-mail; or (9) use any proprietary information or any of our interfaces or our other intellectual property in the design, development, manufacture, licensing, or distribution of any applications, accessories, or devices for use with the application.</Text>
<Text style={{ color: 'black', fontSize: 14, fontWeight: 'bold', marginHorizontal: 15, marginTop: 10 }}>Apple and Android Devices</Text>

 
                        <Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18,marginTop:4}}>The following terms apply when you use a mobile application obtained from either the Apple
Store or Google Play (each an “App Distributor”) to access the Site: (1) the license granted to
you for our mobile application is limited to a non-transferable license to use the application on
...
thereof.</Text>
                        ...
                        <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', marginHorizontal: 15, marginTop: 20 }}>8. SUBMISSIONS</Text>
                        <Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18,marginTop:4}}>You acknowledge and agree that any questions, comments, suggestions, ideas, feedback, or
...
actual infringement or misappropriation of any proprietary right in your Submissions.</Text>
        
                        <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', marginHorizontal: 15 , marginTop: 20}}>9. THIRD-PARTY WEBSITE AND CONTENT </Text>
                        <Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18,marginTop:4}}>The Site may contain (or you may be sent via the Site) links to other websites ("Third-Party
...
originating from third parties ("Third-Party Content"). Such Third-Party Websites and ThirdParty Content are not investigated, monitored, or checked for accuracy, appropriateness, or
...
contact with Third-Party Websites.</Text>

                        <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', marginHorizontal: 15, marginTop: 20 }}>10. SITE MANAGEMENT</Text>
                        <Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18,marginTop:4}}>We reserve the right, but not the obligation, to: (1) monitor the Site for violations of these Terms
...
protect our rights and property and to facilitate the proper functioning of the Site.</Text>

                        <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', marginHorizontal: 15, marginTop: 20 }}>11. PRIVACY POLICY</Text>
                        <Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18,marginTop:4}}>We care about data privacy and security. By using the Site, you agree to be bound by our
...
use of the Site, you are transferring your data to the United States, and you agree to have your
data transferred to and processed in the United States.</Text>


                        <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', marginHorizontal: 15, marginTop: 20 }}>12. TERM AND TERMINATION</Text>
                        <Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18,marginTop:4}}>These Terms of Use shall remain in full force and effect while you use the Site.
...
without limitation pursuing civil, criminal, and injunctive redress.</Text>

                        <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', marginHorizontal: 15, marginTop: 20 }}>13. MODIFICATIONS AND INTERRUPTIONS</Text>
                        <Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18,marginTop:4}}>We reserve the right to change, modify, or remove the contents of the Site at any time or for
...
or to supply any corrections, updates, or releases in connection therewith.</Text>

                        <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', marginHorizontal: 15, marginTop: 20 }}>14. GOVERNING LAW</Text>
                        <Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18,marginTop:4}}>These Terms of Use and your use of the Site are governed by and construed in accordance with the laws of the State of Minnesota applicable to agreements made and to be entirely performed within the State of Minnesota, without regard to its conflict of law principles.</Text>
                         
                        <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', marginHorizontal: 15, marginTop: 20 }}>15. DISPUTE RESOLUTION</Text>
                        <Text style={{ color: 'black', fontSize: 14, fontWeight: 'bold', marginHorizontal: 15,marginTop:10 }}>Informal Negotiations</Text>

                        <Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18,marginTop:4}}>To expedite resolution and control the cost of any dispute, controversy, or claim related to these Terms of Use (each "Dispute" and collectively, the “Disputes”) brought by either you or us (individually, a “Party” and collectively, the “Parties”), the Parties agree to first attempt to negotiate any Dispute (except those Disputes expressly provided below) informally for at least thirty (30) days before initiating arbitration. Such informal negotiations commence upon written notice from one Party to the other Party.</Text>
                      
                        <Text style={{ color: 'black', fontSize: 14, fontWeight: 'bold', marginHorizontal: 15 ,marginTop:10 }}>Binding Arbitration</Text>

                        <Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18,marginTop:4}}>If the Parties are unable to resolve a Dispute through informal negotiations, the Dispute (except
...
AAA website: www.adr.org. Your arbitration fees and your share of arbitrator compensation
...
in Hennepin, Minnesota. Except as otherwise provided herein, the Parties may litigate in court
...
commenced or prosecuted in the state and federal courts located in Hennepin, Minnesota, and
...
the Parties agree to submit to the personal jurisdiction of that court.</Text>


<Text style={{ color: 'black', fontSize: 14, fontWeight: 'bold', marginHorizontal: 15,marginTop:10  }}>Restrictions</Text>

<Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18,marginTop:4}}>The Parties agree that any arbitration shall be limited to the Dispute between the Parties
...
<Text style={{ color: 'black', fontSize: 14, fontWeight: 'bold', marginHorizontal: 15,marginTop:10 }}>Exceptions to Informal Negotiations and Arbitration</Text>

<Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18,marginTop:4}}>The Parties agree that the following Disputes are not subject to the above provisions
concerning informal negotiations and binding arbitration: (a) any Disputes seeking to enforce or
...
submit to the personal jurisdiction of that court.</Text>



<Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', marginHorizontal: 15 }}>16. CORRECTIONS</Text>
                        <Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18,marginTop:4}}>There may be information on the Site that contains typographical errors, inaccuracies, or
...
information on the Site at any time, without prior notice.</Text>
                         
<Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', marginHorizontal: 15 ,marginTop:10 }}>17. DISCLAIMER</Text>
                        <Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18,marginTop:4}}>THE SITE IS PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREE THAT YOUR
...
RESPONSIBLE FOR MONITORING ANY TRANSACTION BETWEEN YOU AND ANY THIRDPARTY PROVIDERS OF PRODUCTS OR SERVICES. AS WITH THE PURCHASE OF A
PRODUCT OR SERVICE THROUGH ANY MEDIUM OR IN ANY ENVIRONMENT, YOU SHOULD
USE YOUR BEST JUDGMENT AND EXERCISE CAUTION WHERE APPROPRIATE.</Text>


<Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', marginHorizontal: 15 }}>18. LIMITATIONS OF LIABILITY </Text>
                        <Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18,marginTop:4}}>IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO
...
APPLY TO YOU, AND YOU MAY HAVE ADDITIONAL RIGHTS.</Text>

<Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', marginHorizontal: 15 }}>19. INDEMNIFICATION</Text>
                        <Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18,marginTop:4}}>You agree to defend, indemnify, and hold us harmless, including our subsidiaries, affiliates, and
...
<Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', marginHorizontal: 15,marginTop:10 }}>20. USER DATA</Text>
                        <Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18,marginTop:4}}>We will maintain certain data that you transmit to the Site for the purpose of managing the
...
action against us arising from any such loss or corruption of such data.</Text>
...
<Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', marginHorizontal: 15 }}>21. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES </Text>
                        <Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18,marginTop:4}}>Visiting the Site, sending us emails, and completing online forms constitute electronic
...
<Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', marginHorizontal: 15 }}>22. CALIFORNIA USERS AND RESIDENTS</Text>
                        <Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18,marginTop:4}}>If any complaint with us is not satisfactorily resolved, you can contact the Complaint
Assistance Unit of the Division of Consumer Services of the California Department of
Consumer Affairs in writing at 1625 North Market Blvd., Suite N 112, Sacramento, California
95834 or by telephone at (800) 952-5210 or (916) 445-1254.</Text>

<Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', marginHorizontal: 15,marginTop:10 }}>23. MISCELLANEOUS USERS AND RESIDENTS</Text>
                        <Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18,marginTop:4}}>These Terms of Use and any policies or operating rules posted by us on the Site or in respect
to the Site constitute the entire agreement and understanding between you and us. Our failure
to exercise or enforce any right or provision of these Terms of Use shall not operate as a waiver
...
these Terms of Use and the lack of signing by the parties hereto to execute these Terms of
Use.</Text>




<Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', marginHorizontal: 15,marginTop:10 }}>24. CONTACT US </Text>
                        <Text style={{ color: 'gray', fontSize: 15, textAlign: 'justify', paddingHorizontal: 18,marginTop:4,marginBottom:15}}>In order to resolve a complaint regarding the Site or to receive further information regarding use
of the Site, please contact us at:{"\n"}
Twin Cities Health Services{"\n"}
3255 Hennepin Ave S{"\n"}
Minneapolis, MN 55408{"\n"}
United States{"\n"}
Phone: (612) 353-5639{"\n"}
legal@neurolifetherapy.com</Text>
