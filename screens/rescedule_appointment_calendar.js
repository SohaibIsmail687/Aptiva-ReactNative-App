...
class rescedule_appointment_calendar extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      appointment_time: this.props.time,
      ...
      .then(response => {
        ...
        if (record4 != 'fail') {
          ...
          for (let i = 0; i < len_mon; i++) {
            ...
            if (
              this.props.day_1 == 'Mon' &&
              this.appointment_time == doctor_time
            ) {
          ...
          if (record1 != 'fail') {
            for (let i = 0; i < len1; i++) {
              ...
              for (let i = 0; i < len; i++) {
                ...
                if (this.state.appointment_time == app_rec_1) {
                  let boxes = 'box' + app_rec_1;
                  this.setState({[boxes]: true});
                  let boxred = 'boxred' + app_rec_1;
                  this.setState({[boxred]: false, skalton: false});
                } else {
  ...
  cancel_appointment = () => {
    if (this.state.appointment_time == '') {
      ...
      uploaddata.append('resecdule_reason', this.props.rescedule_reason);
      uploaddata.append('time', this.state.appointment_time);
      uploaddata.append('date', this.state.appointment_date);
      uploaddata.append('day', this.state.changes_time_for_specific_day);
      let api = Connection + 'rest_apis.php?action=reschedule_appointment';
      fetch(api, {
        method: 'POST',
        headers: {
          'Content-Type': 'multipart/form-data',
  ...
  notification = async () => {
    ...
    fetch('https://fcm.googleapis.com/fcm/send', {
      ...
      body: JSON.stringify({
        ...
        notification: {
          title: 'Neurolife',
          body: this.state.name + ' is rescheduled appointment with you',
          sound: 'default',
          icon: 'myicon',
        },
      }),
                ...
                {this.state[boxred] == true ? (
                  <Pressable
                    ...
                    <Text
                      style={
                        this.state[boxred] == true
                          ? styles.select_text_red
                          : styles.unselect_text_red
                      }>
                      {doctor_time}
                    </Text>
                  </Pressable>
  ...
  traetment = () => {
    if (this.state.appointment_time == '') {
      ...
      setTimeout(() => {
        ...
        Actions.pattient_site_SelectPackage({
  ...
  add_notification = () => {
    ...
    uploaddata.append('type', 'reschedule');
    uploaddata.append('doctor_id', this.props.doctor_id);
          ...
          <View
            ...
            <ScrollView
              ...
              <Pressable
                ...
                style={
                  this.state.day_1 != this.state.changes_time_for_specific_day
                    ? styles.view1
                    : styles.view
                }>
                <Text
              ...
              <Pressable
                ...
                style={
                  this.state.day_2 != this.state.changes_time_for_specific_day
                    ? styles.view1
                    : styles.view
                }>
                <Text
              ...
              <Pressable
                ...
                style={
                  this.state.day_3 != this.state.changes_time_for_specific_day
                    ? styles.view1
                    : styles.view
                }>
                <Text
              ...
              <Pressable
                ...
                style={
                  this.state.day_4 != this.state.changes_time_for_specific_day
                    ? styles.view1
                    : styles.view
                }>
                <Text
              ...
              <Pressable
                ...
                style={
                  this.state.day_5 != this.state.changes_time_for_specific_day
                    ? styles.view1
                    : styles.view
                }>
                <Text
              ...
              <Pressable
                ...
                style={
                  this.state.day_6 != this.state.changes_time_for_specific_day
                    ? styles.view1
                    : styles.view
                }>
                <Text
              ...
              <Pressable
                ...
                style={
                  this.state.day_7 != this.state.changes_time_for_specific_day
                    ? styles.view1
                    : styles.view
                }>
                <Text
          ...
          <DialogContent
            ...
            <View style={{alignItems: 'center'}}>
              ...
              <Text
                ...
                numberOfLines={2}>
                Reschedulling Appointment Success!
              </Text>
