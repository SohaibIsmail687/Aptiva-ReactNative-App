...
<View style={{ width: width / 1.1, backgroundColor: 'white', borderRadius: 10, alignSelf: 'center', shadowOffset: { width: 0, height: 2, }, shadowOpacity: 0.25, shadowRadius: 3.84, elevation: 5, marginTop: 20 }}>
                  <View style={{ flexDirection: 'row', justifyContent: 'space-between', borderBottomWidth: 1, borderColor: 'lightgray' }}>
                    <Text style={{ color: '#781517', marginTop: 5, marginLeft: 10, fontWeight: 'bold' }}>Requested</Text>
                    <View
                      style={{ width: '50%', height: 30, justifyContent: 'center', alignItems: 'center', backgroundColor: 'lightgray' }}>
                      <Text style={{ color: '#781517', fontWeight: 'bold' }}>07 Dec, 2022 </Text>
                    </View>
                  </View>

                  <Text style={{ color: 'black', fontWeight: 'bold', marginLeft: 10, marginTop: 15 }}>Medicine for: Jawad Shiekh</Text>
                  <Text style={{ color: '#781517', fontWeight: 'bold', marginTop: 10, marginLeft: 10, fontSize: 17 }}>Pharmacy, Hibeel Pharmacy</Text>
                  <Text style={{ color: 'gray', fontWeight: 'bold', marginLeft: 10 }}>Circular Road, Narowal</Text>
                  ...
                  <TouchableOpacity  
                    style={{ marginBottom: 20, marginTop: 10, marginLeft: 10, borderWidth: 1, borderColor: '#781517', width: '35%', paddingVertical: 5, borderRadius: 6 }}>
                    <Text style={{ color: '#781517', fontSize: 12, textAlign: 'center' }}>View Details</Text>
                  </TouchableOpacity>
                ...
                <View style={{ width: width / 1.1,marginBottom:10, backgroundColor: 'white', borderRadius: 10, alignSelf: 'center', shadowOffset: { width: 0, height: 2, }, shadowOpacity: 0.25, shadowRadius: 3.84, elevation: 5, marginTop: 20 }}>
                  <View style={{ flexDirection: 'row', justifyContent: 'space-between', borderBottomWidth: 1, borderColor: 'lightgray' }}>
                    <Text style={{ color: '#781517', marginTop: 5, marginLeft: 10, fontWeight: 'bold' }}>Requested</Text>
                    <View
                      style={{ width: '50%', height: 30, justifyContent: 'center', alignItems: 'center', backgroundColor: 'lightgray' }}>
