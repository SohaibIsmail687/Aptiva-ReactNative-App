...
import pharmacy_home from "./pharmacy_home";
import pharmacy_all_orders from "./pharmacy_all_orders";
import chat from "./chat";
import pharmacy_profile from "./pharmacy_profile";
...
class Doctor_Tab_Screen extends React.Component {
    ...
    render() {
        ...
        if (this.state.selectedbtn == "1") {
            AppComponent = pharmacy_home;
        }

        if (this.state.selectedbtn == "2") {
            AppComponent = pharmacy_all_orders;
        }
        if (this.state.selectedbtn == "3") {
            AppComponent = chat;
        }
        if (this.state.selectedbtn == "4") {
            AppComponent = pharmacy_profile;
        }
