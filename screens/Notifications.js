...
class Notifications extends React.Component {
  ...
  componentDidMount = async () => {
    ...
    console.log('QQQQQQQQQQQQ,AA', final_time);
    this.setState({
      time: final_time,
      date: date,
    });
  ...
  get_appointments_user = val => {
    ...
    let api = Connection + 'rest_apis.php?action=display_notification_user';
  ...
  createtable1 = () => {
    ...
    if (record1 != 'fail') {
      for (let i = 0; i < len; i++) {
        ...
        console.log('typetypetypetypetypetypetypetype', type);
                    ...
                    {type == 'cancel' && (
                      <View style={{paddingHorizontal: 20}}>
                        ...
                        <Text
                          ...
                          You have successfully cancelled appointment with{' '}
                          {doctor_name} on {app_date}, {app_time}.
                        </Text>
                        <Text
                          style={{
                            color: 'gray',
                    ...
                    {type == 'reschedule' && (
                      <View style={{paddingHorizontal: 20}}>
                        ...
                        <Text
                          ...
                          You have successfully reschedule appointment with{' '}
                          {doctor_name} on {app_date}, {app_time}.
                        </Text>
                        <Text
                          style={{
                    ...
                    {type == 'complete' && (
                      <View style={{paddingHorizontal: 20}}>
                        ...
                        <Text
                          ...
                          {doctor_name} have successfully completed your
                          appointment on {app_date}, {app_time}.
                        </Text>
                      </View>
                    )}
                    ...
                    {type == 'review' && (
                      <View style={{paddingHorizontal: 20}}>
                        ...
                        <Text
                          ...
                          You have successfully submitted review for{' '}
                          {doctor_name}
                        </Text>
                      </View>
                    )}
            ...
            {this.state.data1 == '' ? (
              <View>
                ...
                <Text
                  ...
                  {this.props.You_dont_have_any_notification_present_at_moment}
                </Text>
              </View>
            ) : (
